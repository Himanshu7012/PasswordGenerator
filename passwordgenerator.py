...
Title = Label(root, text="MY PASSWORD GENERATOR", bg="beige", 
...
generate_btn = Button(root, text="Generate password", bg="orange", 
                      fg="black", font=("ubuntu", 15), cursor="hand2", 
